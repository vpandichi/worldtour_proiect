...
if (logged_in() === true) {
	...
	$user_data = user_data($session_user_id, 'user_id', 'username', 'password', 'first_name', 'last_name', 'email', 'pwd_recovery'); // campurile pe care le preluam din baza de date. Aceasta metoda este foarte flexibila deoarece daca adaugam 1 camp bazei de date tot ce trebuie sa facem e sa adaugam numele campului in acest sir
