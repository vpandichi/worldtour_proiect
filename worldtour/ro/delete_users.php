...
<head>
	<meta charset="UTF-8">
	<title>worldtour | stergere utilizatori</title>
...
<?php
	...
	echo '<a href="admin.php" class="email_success_a">Inapoi la pagina de admin</a>';
		...
		if (empty($_POST) === false) {
			...
			} else if (user_active($_POST['username']) === false) {
	...
	?>	
		<h2 class="active_users_headers">Utilizatori activi...</h2>
		...
		<div class="user_d_form">
			...
			<form action="" method="post" id="updateacc">
				<input type="text" id="lname" name="username" placeholder="utilizator... *">
