			...
			<footer id="footer">
				<div id="recom">
					...
					<ul>
						...
						<li><a href="recom.php" id="#">Other</a></li>
						<li><a href="recom.php" id="#">Other</a></li>
						<li><a href="recom.php" id="#">Other</a></li>
						<li><a href="recom.php" id="#">Other</a></li>
						<li><a href="recom.php" id="#">Other</a></li>
				...
				<div id="featured_location">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea sequi, magnam ipsa deleniti illo totam eum tempore, veniasuscipit! Eligendi, perspiciatis accusamus quisquam harum nesciunt dolor cumque, minima est ex. <a href="recom.php">[Read more...]</a></p>
				</div>
				<div class="social">
